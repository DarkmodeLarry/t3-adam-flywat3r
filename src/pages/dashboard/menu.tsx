...
const Menu: FC = () => {
  ...
  useEffect(() => {
    ...
    // clean up the preview & free memory when ever this component is unmounted
  ...
  const handleFileSelect = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (e.target.files[0].size > MAX_FILE_SIZE) return setError('File size is too large')
    ...
    <>
      <div>
        <div className='mx-auto flex max-w-xl flex-col gap-2'>
          ...
          <label
            htmlFor='file'
            className='relative h-12 cursor-pointer rounded-sm bg-gray-200 font-medium text-indigo-600'
          >
